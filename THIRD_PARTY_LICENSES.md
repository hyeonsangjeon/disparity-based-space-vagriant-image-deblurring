...
## Project-owned historical photographs

The `benchmarks/public-assets/project-owned-historical/` and
`showcase/benchmark/project-owned-historical/` photographs are:
